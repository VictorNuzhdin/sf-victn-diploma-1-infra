...
#  было взято собственное "Python Django PostgreSQL Docker Compose" веб-приложение
#  из связанного проекта "sf-victn-diploma-0-app1" (см. активную ссылку в начале).
